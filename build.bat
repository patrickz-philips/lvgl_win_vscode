...
REM   PROJECT: HAIR_DRYER, SMART_SHAVER, CHEETAH, SLIDE_PLAYER, BATTERY_MONITOR, ACC_DATA, ALGORITHM_ANIMATION (default: HAIR_DRYER)
...
REM   build.bat ALGORITHM_ANIMATION Debug              - Build ALGORITHM_ANIMATION in Debug mode
REM ============================================================
...
if /i not "%PROJECT%"=="HAIR_DRYER" if /i not "%PROJECT%"=="SMART_SHAVER" if /i not "%PROJECT%"=="CHEETAH" if /i not "%PROJECT%"=="SLIDE_PLAYER" if /i not "%PROJECT%"=="BATTERY_MONITOR" if /i not "%PROJECT%"=="ACC_DATA" if /i not "%PROJECT%"=="ALGORITHM_ANIMATION" (
...
if /i "%PROJECT%"=="ALGORITHM_ANIMATION" set PROJECT=ALGORITHM_ANIMATION
...
if /i "%PROJECT%"=="ALGORITHM_ANIMATION" set PROJECT_LOWER=algorithm_animation
